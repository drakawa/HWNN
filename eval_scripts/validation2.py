...
def get_plots(results_dd):
    ...
    # ax.set_ylim([0.0,70])
        ...
        plt.savefig("fig/loss_acc/%s_swopp.eps" % val, transparent=False)
        plt.savefig("fig/loss_acc/%s_swopp.png" % val, transparent=False)
        plt.savefig("fig/loss_acc/%s_swopp.svg" % val, transparent=True)
